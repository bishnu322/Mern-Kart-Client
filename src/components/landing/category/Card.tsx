...
const CategoryCard: React.FC<IProps> = ({ category }) => {
  return (
    <div className=" bg-purple-50 border border-violet-200 p-3 rounded  cursor-pointer  hover:transition-y-1 hover:shadow-lg hover:shadow-gray-400 transition-all duration-200">
